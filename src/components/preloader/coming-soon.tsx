...
//         // Wait for the fade-out duration and then reset fade-out state
//         setTimeout(() => {
//           // Wait for an additional delay before changing the image
//           setTimeout(() => {
//             setIndex((prev) => (prev + 1) % imageCount); // Cycle through images
//             setFadeOut(false); // Reset fade out after changing the image
//           }, 2000); // Additional delay before starting the new image animation
