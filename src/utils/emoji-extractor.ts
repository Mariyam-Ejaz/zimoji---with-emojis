...
const isMobileOrTablet = () => {
  ...
  return width < 1024; // Example threshold; adjust as needed for tablets
};

// Define available emojis for mobile (GIF) and desktop (WebP)
const availableEmojisMobile = [
  '/emojis/512 (1).gif',
  '/emojis/512 (2).gif',
  '/emojis/512 (3).gif',
  '/emojis/512 (4).gif',
...
export const extractEmojiUrls = () => {
  const availableEmojis = isMobileOrTablet() ? availableEmojisMobile : availableEmojisDesktop;
